...
export default function Home() {
  ...
  const filtered = coursesData
    .filter(course => {
      return (!filters.wilaya || course.wilaya.toLowerCase().includes(filters.wilaya.toLowerCase()))
        && (!filters.type || course.type.toLowerCase().includes(filters.type.toLowerCase()));
    })
    .sort((a, b) => {
      const now = new Date();
